...
import (
	...
	"github.com/docker/docker/v24/builder/builder-next/adapters/containerimage"
	"github.com/docker/docker/v24/builder/builder-next/adapters/localinlinecache"
	"github.com/docker/docker/v24/builder/builder-next/adapters/snapshot"
	containerimageexp "github.com/docker/docker/v24/builder/builder-next/exporter"
	"github.com/docker/docker/v24/builder/builder-next/imagerefchecker"
	mobyworker "github.com/docker/docker/v24/builder/builder-next/worker"
