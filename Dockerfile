...
RUN --mount=from=skopeo,source=/out/skopeo,target=/usr/bin/skopeo <<EOT
  ...
  skopeo --insecure-policy copy docker://arm32v7/hello-world@sha256:50b8560ad574c779908da71f7ce370c0a2471c098d44d1c8f6b513c5a55eeeb1 --additional-tag arm32v7/hello-world:latest docker-archive:///out/arm32v7-hello-world-latest.tar
EOT
