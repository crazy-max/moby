...
import (
	...
	ctrd "github.com/docker/docker/v24/daemon/containerd"
	"github.com/docker/docker/v24/daemon/events"
	_ "github.com/docker/docker/v24/daemon/graphdriver/register" // register graph drivers
	"github.com/docker/docker/v24/daemon/images"
	dlogger "github.com/docker/docker/v24/daemon/logger"
	"github.com/docker/docker/v24/daemon/network"
	"github.com/docker/docker/v24/daemon/stats"
	dmetadata "github.com/docker/docker/v24/distribution/metadata"
	...
	nwconfig "github.com/docker/docker/v24/libnetwork/config"
	"github.com/docker/docker/v24/pkg/fileutils"
	...
	pluginexec "github.com/docker/docker/v24/plugin/executor/containerd"
	refstore "github.com/docker/docker/v24/reference"
